  ...
  return (
    <form className="space-y-5" onSubmit={handleSubmit(onSubmit)}>
      ...
      <div className="flex flex-col gap-1">
        ...
        <input
          className={`min-w-72 rounded-md border bg-input_bg px-3  py-2  text-lg focus:outline-none ${errors.password && "border-red-500"}`}
          id="password"
          type="password"
      ...
      <div className="flex flex-col gap-1">
        ...
        <input
          className={`min-w-72 rounded-md border bg-input_bg px-3  py-2  text-lg focus:outline-none ${errors.confirm_password && "border-red-500"}`}
          id="confirm_password"
          type="password"
