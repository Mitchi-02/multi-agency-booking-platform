...
import { UpdateBookingSchema } from "@/lib/schemas/hike"
  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)}>
      <h1 className="mb-4 text-3xl font-black leading-none tracking-tight">
        Booking Details of Hike{" "}
        <Link href={`/hikes/${data.hike._id}`} className="text-primary-blue underline">
          {data.hike.destination}
        </Link>
      </h1>
      ...
      <div className="my-6 grid grid-cols-3 justify-between gap-10 rounded-lg bg-[#FCFCFC] p-6">
        ...
        <div>
          ...
          <Select onValueChange={(v) => setValue("method", v)} defaultValue={data.method}>
